...
def parse_option():
    ...
    parser.add_argument('--cfg', type=str, default='./cfgs/h_vittt_t.yaml', metavar="FILE", help='path to config file', )
    parser.add_argument(
        "--opts",
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        info.append('PASS: same input, same output' if result == 0.0 else 'FAIL: same input, different output, diff = {}'.format(result))
