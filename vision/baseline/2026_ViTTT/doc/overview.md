...
> Softmax Attention은 width=N인 2-layer MLP를 K,V로 구성한 것과 같다 (Eq.2).
> W₁ = K^T/√d, W₂ = V로 놓으면 O = σ(Q·W₁)·W₂ 형태의 MLP가 된다.
> (Eq.1의 1/√d 스케일링은 W₁에 흡수된다.)
